...
public class Weapon
{
    ...
    public Weapon(Vector3 idlePosition, Vector3 aimPosition, float fireRate, float damage, bool isAutomatic, ParticleSystem muzzleFlash, AudioSource shootSound,AudioSource reloadSound, int maxAmmo, int maxClipAmmo, float reloadTime)
    {
