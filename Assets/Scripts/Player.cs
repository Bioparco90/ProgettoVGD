...
public class PlayerController : MonoBehaviour
{
    ...
    public float lookXLimit = 45.0f; //Angolo limite oltre il quale la camera non pu� andare
    ...
    void Update()
    {
        ...
        //Assegno la velocit� di movimento corretta a seconda che il player stia correndo o camminando
        ...
        //Se il player non � a terra devo applicargli la gravit�
        if (!ch.isGrounded)
